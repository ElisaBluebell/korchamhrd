...
#
# from thread_test import MainPage
#
#
# class LoginPage(QWidget):
#
#     def __init__(self):
#         # th1 = Thread(target=MainPage.refresh_calendar)
#         # th2 = Thread(target=self.print1)
#         super().__init__()
#         # 유저 DB를 담을 리스트
#         self.user_info = []
#         # 첫 로그인 확인을 위한 변수
...
holiday2 = ['2023-03-02']
holiday4 = ['2023-01-13', '2023-05-08']

print(str(datetime.date.today()))

if str(datetime.date.today()) in holiday4:
    print(1)